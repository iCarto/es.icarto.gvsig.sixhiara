...
rm ${BASE_PATCHES_PATH}/gvSIG/extensiones/org.gvsig.gdal.app.ogr.mainplugin/lib/org.gvsig.gdal.prov.ogr-1.0.30.jar
...
rm ${BASE_PATCHES_PATH}/gvSIG/extensiones/org.gvsig.app.mainplugin/lib/postgresql-9.1-901.jdbc3.jar
cp portable/common/patches/postgresql-42.2.6.jar ${BASE_PATCHES_PATH}/gvSIG/extensiones/org.gvsig.app.mainplugin/lib/postgresql-42.2.6.jar
