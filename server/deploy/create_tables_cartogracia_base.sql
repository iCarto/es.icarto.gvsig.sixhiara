...
CREATE TABLE "cbase"."estacoes_pluviometricas" (gid serial,
"estazon" varchar(254),
"cod_estac" varchar(254),
"tip_estac" varchar(254),
...
"ano_fin" numeric,
"n_anos" numeric,
"frec_toma" varchar(254),
"frec_regi" varchar(254),
"nivel" int2,
"n_precis" varchar(254),
"lin_em" int2,
"n_lin_em" numeric,
"n_outros" int2,
"n_t_outro" varchar(254),
"velocidad" int2,
"v_precis" varchar(254),
"molinetes" int2,
"n_molinet" numeric,
"v_outros" int2,
...
"caudal" int2,
"pluviomet" int2,
"tip_pluvi" varchar(254),
"n_pluviom" numeric,
"coment" varchar(254),
"et_id" numeric);
ALTER TABLE "cbase"."estacoes_pluviometricas" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','estacoes_pluviometricas','geom','32737','POINT',2);
CREATE INDEX ON "cbase"."estacoes_pluviometricas" USING GIST ("geom");

CREATE TABLE "cbase"."estacoes_hidrometricas" (gid serial,
"estazon" varchar(254),
"cod_estac" varchar(254),
"tip_estac" varchar(254),
"provincia" varchar(254),
...
"coment" varchar(254),
"et_id" numeric);
ALTER TABLE "cbase"."estacoes_hidrometricas" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','estacoes_hidrometricas','geom','32737','POINT',2);
CREATE INDEX ON "cbase"."estacoes_hidrometricas" USING GIST ("geom");
...
CREATE TABLE "cbase"."direcao_fluxo" (gid serial,
"campo1" varchar(20));
ALTER TABLE "cbase"."direcao_fluxo" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','direcao_fluxo','geom','32737','MULTILINESTRING',2);
CREATE INDEX ON "cbase"."direcao_fluxo" USING GIST ("geom");
...
CREATE TABLE "cbase"."piezo_v0" (gid serial,
"id" int4,
"cota_piezo" int2);
ALTER TABLE "cbase"."piezo_v0" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','piezo_v0','geom','32737','MULTILINESTRING',4);
CREATE INDEX ON "cbase"."piezo_v0" USING GIST ("geom");

CREATE TABLE "cbase"."dir_fluxo" (gid serial,
"campo1" varchar(20));
ALTER TABLE "cbase"."dir_fluxo" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','dir_fluxo','geom','32737','MULTILINESTRING',2);
CREATE INDEX ON "cbase"."dir_fluxo" USING GIST ("geom");
...
CREATE TABLE "cbase"."rdcongo" (gid serial,
"gadmid" int2,
"iso" varchar(5),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."rdcongo" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','rdcongo','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."rdcongo" USING GIST ("geom");

CREATE TABLE "cbase"."zimbabwe" (gid serial,
"name_spani" varchar(50));
ALTER TABLE "cbase"."zimbabwe" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','zimbabwe','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."zimbabwe" USING GIST ("geom");

CREATE TABLE "cbase"."angola" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."angola" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','angola','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."angola" USING GIST ("geom");

CREATE TABLE "cbase"."namibia" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."namibia" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','namibia','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."namibia" USING GIST ("geom");

CREATE TABLE "cbase"."zambia" (gid serial,
"name_spani" varchar(50));
ALTER TABLE "cbase"."zambia" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','zambia','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."zambia" USING GIST ("geom");

CREATE TABLE "cbase"."lesotho" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."lesotho" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','lesotho','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."lesotho" USING GIST ("geom");
...
CREATE TABLE "cbase"."south_africa" (gid serial,
"name_spani" varchar(50));
ALTER TABLE "cbase"."south_africa" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','south_africa','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."south_africa" USING GIST ("geom");

CREATE TABLE "cbase"."botswana" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."botswana" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','botswana','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."botswana" USING GIST ("geom");
...
CREATE TABLE "cbase"."swaziland" (gid serial,
"name_spani" varchar(50));
ALTER TABLE "cbase"."swaziland" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','swaziland','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."swaziland" USING GIST ("geom");

CREATE TABLE "cbase"."congo" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."congo" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','congo','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."congo" USING GIST ("geom");
...
CREATE TABLE "cbase"."madagascar" (gid serial,
"gadmid" int2,
"iso" varchar(5),
"name_engli" varchar(50),
"name_iso" varchar(54),
...
"shape_leng" numeric,
"shape_area" numeric);
ALTER TABLE "cbase"."madagascar" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','madagascar','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."madagascar" USING GIST ("geom");
...
CREATE TABLE "cbase"."cotas" (gid serial,
"altitude" float8);
ALTER TABLE "cbase"."cotas" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','cotas','geom','32737','POINT',2);
CREATE INDEX ON "cbase"."cotas" USING GIST ("geom");
...
CREATE TABLE "cbase"."estaçoes_pluviometricas" (gid serial,
"tipo_de_da" varchar(254),
"aparelhos_" varchar(254),
"altitude" float8,
"ano_instal" float8,
"entidade_e" varchar(254),
"bacia" varchar(254),
"sub_bacia" varchar(254),
"pro_distri" varchar(254),
"posto_admi" varchar(254));
ALTER TABLE "cbase"."estaçoes_pluviometricas" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','estaçoes_pluviometricas','geom','32737','POINT',2);
CREATE INDEX ON "cbase"."estaçoes_pluviometricas" USING GIST ("geom");

CREATE TABLE "cbase"."estaçoes_hidrometricas" (gid serial,
"tipo_de_da" varchar(254),
"aparelhos_" varchar(254),
"altitude" float8,
"ano_instal" float8,
...
"distrito" varchar(254),
"posto_admi" varchar(254),
"localidade" varchar(254));
ALTER TABLE "cbase"."estaçoes_hidrometricas" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','estaçoes_hidrometricas','geom','32737','POINT',2);
CREATE INDEX ON "cbase"."estaçoes_hidrometricas" USING GIST ("geom");
...
CREATE TABLE "cbase"."biodiversidad_region" (gid serial,
"descricao" varchar(25));
ALTER TABLE "cbase"."biodiversidad_region" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','biodiversidad_region','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."biodiversidad_region" USING GIST ("geom");
...
CREATE TABLE "cbase"."reserva_do_niassa" (gid serial,
"toponimo" varchar(50),
"area" float8);
ALTER TABLE "cbase"."reserva_do_niassa" ADD PRIMARY KEY (gid);
SELECT AddGeometryColumn('cbase','reserva_do_niassa','geom','32737','MULTIPOLYGON',2);
CREATE INDEX ON "cbase"."reserva_do_niassa" USING GIST ("geom");
